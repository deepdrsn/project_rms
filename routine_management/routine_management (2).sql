...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=860305866ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=routine_management&table=schedules">`routine_management`.`schedules`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=routine_management&table=teachers">`routine_management`.`teachers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=routine_management&table=teacher">`routine_management`.`teacher`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=routine_management&table=students">`routine_management`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=routine_management&table=admins">`routine_management`.`admins`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rms1&table=routines">`rms1`.`routines`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rms1&table=classes">`rms1`.`classes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=routine_management&table=semesters">`routine_management`.`semesters`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=routine_management&table=routines">`routine_management`.`routines`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=routine_management&table=users">`routine_management`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="494670482e33774f42452b4041634478">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="routine_management" targettable="schedules">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `schedules`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="routine_management" targettable="students">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `students`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="routine_management" targettable="teacher">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `teacher`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="routine_management" targettable="teachers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `teachers`  
ORDER BY `teachers`.`name` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="routine_management" targettable="teachers">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `teachers`  
ORDER BY `teachers`.`name`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="routine_management" targettable="teachers">
                            <div class="action_content">
...
ORDER BY `teachers`.`name`  DESC</span>
            ...
            Queried time
                            ...
                            <span class="query">EXPLAIN SELECT * FROM `teachers` ORDER BY `name`  DESC;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="routine_management" targettable="teachers">
                            <div class="action_content">
